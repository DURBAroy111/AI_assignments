...
-DLS function restricts the depth of exploration, allowing the search to terminate when the depth limit is reached.
-It checks if the depth limit is reached before continuing the exploration.
